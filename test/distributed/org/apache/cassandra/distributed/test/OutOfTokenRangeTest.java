...
public class OutOfTokenRangeTest extends TestBaseImpl
{
    ...
    {
        cluster = init(Cluster.build().withNodes(2).withConfig(c -> c.set("enable_secondary_index", true)).start(), 2);
    ...
    @Test
    public void checkSinglePartitionReadCommandTest() throws Throwable
    {
    ...
    @Test
    public void checkPartitionRangeReadCommandTest() throws Throwable
    {
