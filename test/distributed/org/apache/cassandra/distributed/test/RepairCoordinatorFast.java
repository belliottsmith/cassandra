...
public abstract class RepairCoordinatorFast extends RepairCoordinatorBase
{
    ...
    public void prepareFailure()
    {
        ...
        IMessageFilters.Filter filter = CLUSTER.filters()
                                               .inbound()
                                               .messagesMatching(ClusterUtils.repairMatcher(RepairMessage.Type.PREPARE_MESSAGE, (from, to, m) -> {
    ...
    public void snapshotFailure()
    {
        ...
        IMessageFilters.Filter filter = CLUSTER.filters()
                                               .inbound()
                                               .messagesMatching(ClusterUtils.repairMatcher(RepairMessage.Type.SNAPSHOT, (from, to, m) -> {
