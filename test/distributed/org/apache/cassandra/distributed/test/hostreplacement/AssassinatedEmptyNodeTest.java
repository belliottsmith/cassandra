...
import static org.apache.cassandra.distributed.shared.ClusterUtils.getBroadcastAddressString;
...
public class AssassinatedEmptyNodeTest extends BaseAssassinatedCase
{
    ...
    {
        return "Could not find tokens for " + getBroadcastAddressString(nodeToRemove) + " to replace";
    }
