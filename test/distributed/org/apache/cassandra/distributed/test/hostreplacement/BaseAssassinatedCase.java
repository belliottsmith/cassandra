...
import static org.apache.cassandra.distributed.shared.ClusterUtils.getBroadcastAddressHostString;
...
public abstract class BaseAssassinatedCase extends TestBaseImpl
{
    ...
    public void test() throws IOException
    {
                                      ...
                                      .start())
        {
            ...
            peer.nodetoolResult("assassinate", getBroadcastAddressHostString(nodeToRemove))
                .asserts().success();
            ...
            assertThatThrownBy(() ->
                               replaceHostAndStart(cluster, nodeToRemove, properties -> {
                                   ...
                                   properties.setProperty("cassandra.schema_delay_ms", "10");
                               }))
            .hasRootCauseMessage(expectedMessage(nodeToRemove));
        }
    }
}
