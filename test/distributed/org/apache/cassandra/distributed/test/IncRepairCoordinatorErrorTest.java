...
public class IncRepairCoordinatorErrorTest extends TestBaseImpl
{
    ...
    public void errorTest() throws Exception
    {
                                           ...
                                           .start()))
        {
            ...
            TimeUUID parentId = (TimeUUID) cluster.get(1).executeInternal("select parent_id from system_distributed.repair_history")[0][0];
            cluster.get(3).runOnInstance(() -> {
                ActiveRepairService.instance.failSession(parentId.toString(), true);
            });
