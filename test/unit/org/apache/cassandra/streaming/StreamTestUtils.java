...
public class StreamTestUtils
{
    static StreamSession session()
    {
        ...
        StreamCoordinator streamCoordinator = new StreamCoordinator(StreamOperation.REPAIR, 1, new DefaultConnectionFactory(), false, null, PreviewKind.NONE);
        StreamResultFuture future = StreamResultFuture.init(UUID.randomUUID(), StreamOperation.REPAIR, Collections.<StreamEventHandler>emptyList(), streamCoordinator);
