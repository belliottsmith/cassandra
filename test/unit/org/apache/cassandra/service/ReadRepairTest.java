...
public class ReadRepairTest
{
    ...
    static CFMetaData cfm;
    static InetAddress target1;
    static InetAddress target2;
    static InetAddress target3;
    ...
    public static void setUpClass() throws Throwable
    {
        ...
        cfm = CFMetaData.compile("CREATE TABLE tbl (k int primary key, v text)", ksName);
        ...
        target1 = InetAddress.getByName("127.0.0.255");
        target2 = InetAddress.getByName("127.0.0.254");
        target3 = InetAddress.getByName("127.0.0.253");
    ...
    {
        return BufferCell.live(cfm, cfm.getColumnDefinition(ColumnIdentifier.getInterned(name, false)), timestamp, ByteBufferUtil.bytes(value));
    }
    ...
    public void remoteDCTest() throws Exception
    {
        ...
        InetAddress remote1 = InetAddress.getByName("10.0.0.1");
