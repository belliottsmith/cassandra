...
public class MinSSTableVersionCheckTest
{
    ...
    private void execute() throws StartupException
    {
        ...
        StartupChecks.checkSSTablesFormat.execute(new StartupChecksOptions());
    }
    ...
    private File writeFile(Version version) throws IOException
    {
        ...
        String filename = new Descriptor(version, dir, KEYSPACE, TABLE, Util.newSeqGen().get(), SSTableFormat.Type.BIG).filenameFor(Component.DATA);
