...
public class AccordTestUtils
{
        ...
        Node.Id node, LongSupplier now, Topology topology, ExecutorPlus loadExecutor, ExecutorPlus saveExecutor)
    {
        ...
        AccordCommandStore result = new AccordCommandStore(0,
                                                           ...
                                                           holder,
                                                           journal,
                                                           new AccordExecutorSyncSubmit(RUN_WITH_LOCK, CommandStore.class.getSimpleName() + '[' + 0 + ']', new AccordStateCacheMetrics("test"), loadExecutor, saveExecutor, loadExecutor, agent));
        holder.set(result);
