...
public class SpiffeCertificateValidatorTest
{
    ...
    {
        final SpiffeCertificateValidator validator = new SpiffeCertificateValidator();
        final Certificate[] chain = loadCertificateChain(CERTIFICATE_PATH);
        final String spiffe = validator.identity(chain);
    ...
    {
        final SpiffeCertificateValidator validator = new SpiffeCertificateValidator();
        final String invalidCertificate = "auth/SampleInvalidCertificate.pem";
        final Certificate[] chain = loadCertificateChain(invalidCertificate);
