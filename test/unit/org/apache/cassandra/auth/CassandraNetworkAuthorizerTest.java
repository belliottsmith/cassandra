...
public class CassandraNetworkAuthorizerTest
{
    ...
    public static void defineSchema() throws ConfigurationException
    {
        ...
        Roles.initRolesCache(new RolesCache(DatabaseDescriptor.getRoleManager(), true));
    }

    @Before
    public void clear() throws Exception
    {
        Keyspace.open(AuthKeyspace.NAME).getColumnFamilyStore(NETWORK_PERMISSIONS).truncateBlocking();
    }
    ...
    {
        CQLStatement statement = QueryProcessor.parseStatement(String.format(query, args)).prepare(ClientState.forInternalCalls()).statement;
    ...
    public void superUser() throws Exception
    {
        ...
        // re-init the roles cache to clear the (non-)superuser status for the user
        Roles.initRolesCache(new RolesCache(DatabaseDescriptor.getRoleManager(), true));
