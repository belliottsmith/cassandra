...
public class CassandraRoleManagerTest
{
    ...
    @Test
    public void getGrantedRolesImplMinimizesReads() throws Exception
    {
        // IRoleManager::getGrantedRoles was not in the initial API, so a default impl
    ...
    private void fetchRolesAndCheckReadCount(IRoleManager roleManager, RoleResource primaryRole)
    {
        ...
        Set<Role> granted = roleManager.getGrantedRoles(primaryRole);
