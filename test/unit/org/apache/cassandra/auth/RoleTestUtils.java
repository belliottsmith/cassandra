...
public class RoleTestUtils
{
     ...
     */
    public static class LocalExecutionRoleManager extends CassandraRoleManager
    {
    ...
    {
        ColumnFamilyStore rolesTable = Keyspace.open(AuthKeyspace.NAME).getColumnFamilyStore(AuthKeyspace.ROLES);
