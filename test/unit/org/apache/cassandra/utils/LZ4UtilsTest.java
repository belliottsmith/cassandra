...
public class LZ4UtilsTest
{
    ...
    public void compress_and_decompress_small() throws IOException
    {
        ...
        ByteBuf compressedBuf = LZ4Utils.compress(compressor, checksum, expectedBuf);
        ByteBuf decompressedBuf = LZ4Utils.decompress(decompressor, checksum, compressedBuf);
                                              ...
                                              Checksum checksum, int blockSize) throws IOException
    {
        ...
        ByteBuf compressedBuf = LZ4Utils.compress(compressor, checksum, expectedBuf, blockSize, 0, expectedBuf.readableBytes());
        ByteBuf decompressedBuf = LZ4Utils.decompress(decompressor, checksum, compressedBuf);
