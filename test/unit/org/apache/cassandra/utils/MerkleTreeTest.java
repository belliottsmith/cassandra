...
public class MerkleTreeTest
{
    ...
    public void differenceSmallRange()
    {
        ...
        assertEquals(MerkleTree.Difference.FULLY_INCONSISTENT, MerkleTree.differenceHelper(ltree, rtree, new ArrayList<>(), new TreeRange(ltree.fullRange.left, ltree.fullRange.right, (byte)0)));
    }
