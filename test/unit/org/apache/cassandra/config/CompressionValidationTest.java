...
public class CompressionValidationTest extends CQLTester
{
    ...
    {
        originalAllowDisabledCompression = System.setProperty(SYSTEM_PROPERTY_ALLOW_DISABLED_COMPRESSION, "true");
    }
    @AfterClass
    static public void afterClass()
    {
        if (originalAllowDisabledCompression != null)
        {
            System.setProperty(SYSTEM_PROPERTY_ALLOW_DISABLED_COMPRESSION, originalAllowDisabledCompression);
        }
        else
        {
            System.clearProperty(SYSTEM_PROPERTY_ALLOW_DISABLED_COMPRESSION);
        }
    }
