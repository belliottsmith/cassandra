...
public class ConfigCompatabilityTest
{
    ...
    {
        diff(TEST_DIR + "/version=3.0.0-alpha1.yml", REMOVED_IN_40, EXPECTED_ERRORS_403);
    }

    @Test
    public void diff_3_11() throws IOException
    {
        diff(TEST_DIR + "/version=3.11.0.yml", REMOVED_IN_40, EXPECTED_ERRORS_403);
    }
