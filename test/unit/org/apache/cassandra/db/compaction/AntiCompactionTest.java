...
public class AntiCompactionTest
{
    ...
    public void antiCompactOne() throws Exception
    {
        ...
        try (Transaction txn = store.getDataTracker().tryModify(sstables, OperationType.ANTICOMPACTION);
    ...
    public void antiCompactionSizeTest() throws InterruptedException, IOException
    {
        ...
        try (Transaction txn = cfs.getDataTracker().tryModify(sstables, OperationType.ANTICOMPACTION);
             Refs<SSTableReader> refs = Refs.ref(sstables))
        {
