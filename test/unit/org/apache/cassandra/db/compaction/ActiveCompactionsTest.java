...
public class ActiveCompactionsTest extends CQLTester
{
    ...
    public void testSecondaryIndexTracking() throws Throwable
    {
        ...
        Index idx = Iterables.getOnlyElement(getCurrentColumnFamilyStore().indexManager.listIndexes());
        Set<SSTableReader> sstables = getCurrentColumnFamilyStore().getLiveSSTables();

        SecondaryIndexBuilder builder = new SecondaryIndexBuilder(getCurrentColumnFamilyStore(), Collections.singleton(idx), new ReducingKeyIterator(sstables), sstables);
    ...
    public void testViewBuildTracking() throws Throwable
    {
        ...
        ViewBuilder vbt = new ViewBuilder(getCurrentColumnFamilyStore(), view);
    ...
    {
        AutoSavingCache.Writer writer = CacheService.instance.keyCache.getWriter(100, false);
        MockActiveCompactions mockActiveCompactions = new MockActiveCompactions();
