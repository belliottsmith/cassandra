...
public class WrapCellsBuilderCQLTest extends CQLTester
{
    ...
    public void resolvesOnUpdate() throws Throwable
    {
        ...
        assertCalled(ImmutableMap.of(Call.ADD, 1, Call.END_COL, 1));
        ...
        assertCalled(ImmutableMap.of(Call.ADD, 3, Call.END_COL, 2));
        ...
        assertCalled(ImmutableMap.of(Call.ADD, 7, Call.END_COL, 2));
