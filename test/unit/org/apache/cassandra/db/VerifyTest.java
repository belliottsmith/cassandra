...
public class VerifyTest
{
    ...
    public static void defineSchema() throws ConfigurationException
    {
        ...
        SchemaLoader.createKeyspace(KEYSPACE,
                                    ...
                                    SchemaLoader.standardCFMD(KEYSPACE, BF_ALWAYS_PRESENT)
    ...
    public void testOutOfRangeTokens() throws IOException
    {
        ...
        tk1[0] = 2;
        tk2[0] = 1;
        tmd.updateNormalToken(new ByteOrderedPartitioner.BytesToken(tk1), InetAddress.getByName("127.0.0.1"));
        tmd.updateNormalToken(new ByteOrderedPartitioner.BytesToken(tk2), InetAddress.getByName("127.0.0.2"));
    ...
    @Test
    public void testMutateRepair() throws IOException, InterruptedException, ExecutionException
    {
        CompactionManager.instance.disableAutoCompaction();
        Keyspace keyspace = Keyspace.open(KEYSPACE);
        ColumnFamilyStore cfs = keyspace.getColumnFamilyStore(CORRUPT_CF2);
