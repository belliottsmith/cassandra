...
public class TrackerTest
{
    ...
    public void testMemtableReplacement()
    {
        ...
        Memtable prev1 = tracker.switchMemtable(true, new Memtable(CommitLog.instance.getCurrentPosition(), cfs));
        ...
        prev1.setCommitLogContiguousUpperBound(CommitLog.instance.getCurrentPosition());
        barrier1.issue();
        ...
        prev2.setCommitLogContiguousUpperBound(CommitLog.instance.getCurrentPosition());
        barrier2.issue();
        ...
        tracker.subscribe(listener);
        prev1 = tracker.switchMemtable(false, new Memtable(CommitLog.instance.getCurrentPosition(), cfs));
        tracker.markFlushing(prev1);
