...
public class SelectStatementTest
{
    ...
    {
        ParsedStatement.Prepared stmt = QueryProcessor.parseStatement(query).prepare(ClientState.forInternalCalls());
        assert stmt.statement instanceof SelectStatement;
        return (SelectStatement) stmt.statement;
    }
