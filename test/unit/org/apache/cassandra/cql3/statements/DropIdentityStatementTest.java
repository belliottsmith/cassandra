...
public class DropIdentityStatementTest
{
    ...
    @Test
    public void testNonSuperUserCannotDropIdentities()
    {
        ...
        final String query = String.format("DROP IDENTITY '%s';", IDENTITY);
        expectedException.expect(UnauthorizedException.class);
        expectedException.expectMessage("Only superusers can drop identities");
    ...
    public void dropRoleSholdRemoveAllAssociatedIdentities()
    {
        ...
        final String identity1 = "urn:certmanager:idmsGroup/5678";
    ...
    public void ifExistsTest()
    {
        ...
        final String dropQueryWithIfExists = String.format("DROP IDENTITY IF EXISTS '%s'", IDENTITY);
        ...
        final String dropQueryWithOutIfExists = String.format("DROP IDENTITY '%s'", IDENTITY);
