...
public class KeyCacheCqlTest extends CQLTester
{
    ...
    private void testSliceQueries() throws Throwable
    {
        ...
        StorageService.instance.forceKeyspaceFlush(KEYSPACE_PER_TEST, UNIT_TESTS);
    ...
    private void insertDataWithWideRows(String table) throws Throwable
    {
        ...
        Keyspace.open(KEYSPACE_PER_TEST).getColumnFamilyStore(table).forceBlockingFlush(UNIT_TESTS);
