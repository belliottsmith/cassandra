...
public class ErrorMessageTest extends EncodeAndDecodeTestBase<ErrorMessage>
{
    ...
    public void testV5ReadFailureSerDeser()
    {
        ...
        ErrorMessage deserialized = encodeThenDecode(ErrorMessage.fromException(rfe, 0), ProtocolVersion.V5);
    ...
    public void testV5WriteFailureSerDeser()
    {
        ...
        ErrorMessage deserialized = encodeThenDecode(ErrorMessage.fromException(wfe, 0), ProtocolVersion.V5);
    ...
    public void testV5CasWriteTimeoutSerDeser()
    {
        ...
        ErrorMessage deserialized = encodeThenDecode(ErrorMessage.fromException(ex, 0), ProtocolVersion.V5);
    ...
    public void testV4CasWriteTimeoutSerDeser()
    {
        ...
        ErrorMessage deserialized = encodeThenDecode(ErrorMessage.fromException(ex, 0), ProtocolVersion.V4);
