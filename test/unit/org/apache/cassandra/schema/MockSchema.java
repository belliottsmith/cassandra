...
public class MockSchema
{
    ...
    {
        return sstable(generation, 0, false, first, last, cfs, Integer.MAX_VALUE);
    }

    public static SSTableReader sstable(int generation, long first, long last, int minLocalDeletionTime, ColumnFamilyStore cfs)
    {
        return sstable(generation, 0, false, first, last, cfs, minLocalDeletionTime);
    }
    ...
    {
        return sstable(generation, size, keepRef, generation, generation, cfs, Integer.MAX_VALUE);
    }
    ...
    {
        return sstable(generation, size, keepRef, firstToken, lastToken, cfs, Integer.MAX_VALUE);
    }

    public static SSTableReader sstable(int generation, int size, boolean keepRef, long firstToken, long lastToken, ColumnFamilyStore cfs, int minLocalDeletionTime)
    {
