...
public class Datacenters
{
    ...
    {
        private static final String thisDc = DatabaseDescriptor.getEndpointSnitch().getDatacenter(FBUtilities.getBroadcastAddress());
    }
    ...
    public static Set<String> getValidDatacenters()
    {
        ...
        for (InetAddress peer : StorageService.instance.getTokenMetadata().getAllEndpoints())
        {
