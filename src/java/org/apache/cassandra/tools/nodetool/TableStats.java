...
public class TableStats extends NodeToolCmd
{
    ...
    public void execute(NodeProbe probe)
    {
        ...
        out.println("Total number of tables: " + probe.getNumberOfTables());
        out.println("----------------");
        ...
        for (Map.Entry<String, List<ColumnFamilyStoreMBean>> entry : tableStoreMap.entrySet())
        {
            ...
            for (ColumnFamilyStoreMBean table : columnFamilies)
            {
                ...
                out.println("\t\tOld SSTable count: " + probe.getColumnFamilyMetric(keyspaceName, tableName, "OldVersionSSTableCount"));
                ...
                {
                    out.println("\t\tPercent repaired: " + (Math.round(100 * percentRepaired) / 100.0));
                }
