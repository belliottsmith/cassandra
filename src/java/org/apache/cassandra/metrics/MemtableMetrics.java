...
{
    public static final MemtableMetrics instance = new MemtableMetrics();
    ...
    protected final Meter lockedWrites;

    protected final Meter contendedWrites;
    ...
    public void contendedWrite()
    {
        contendedWrites.mark();
    }
}
