...
public interface TableRepairManager
{
     ...
     * be purged or not.
     */
    ValidationPartitionIterator getValidationIterator(Collection<Range<Token>> ranges, TimeUUID parentId, TimeUUID sessionID, boolean isIncremental, int nowInSec, TopPartitionTracker.Collector topPartitionCollector, PreviewKind previewKind) throws IOException, NoSuchRepairSessionException;
