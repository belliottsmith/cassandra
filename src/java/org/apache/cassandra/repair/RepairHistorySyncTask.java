 ...
 */
public class RepairHistorySyncTask extends AsyncFuture<Object>
{
    ...
    static class HistoryCallback extends AsyncFuture<Map<InetAddressAndPort, RangeTimes>> implements RequestCallback<Response>
    {
        ...
        {
            tryFailure(new RuntimeException(String.format("%s failed", from)));
        }
        ...
        public synchronized void onResponse(Message<Response> msg)
        {
            ...
            {
                trySuccess(ImmutableMap.copyOf(data));
            }
        }
    }
    ...
    static class CorrectionCallback extends AsyncFuture<Object> implements RequestCallback<Object>
    {
    ...
    private AsyncFuture<Object> processHistory(Map<InetAddressAndPort, RangeTimes> history)
    {
        ...
        if (corrections.isEmpty())
        {
            ...
            return ImmediateFuture.success(new Object());
        }
        else
        {
    ...
    public void execute()
    {
        ...
        callback.map(this::processHistory, ImmediateExecutor.INSTANCE).addCallback(new FutureCallback<Object>()
        {
            public void onSuccess(@Nullable Object result)
            {
                ...
                RepairHistorySyncTask.this.trySuccess(result);
            }

            public void onFailure(Throwable t)
            {
                logger.error("Repair history sync failed for for {}", RepairHistorySyncTask.this, t);
                RepairHistorySyncTask.this.tryFailure(t);
            }
