...
public class CoordinatorSessions
{
    ...
    public synchronized CoordinatorSession registerSession(UUID sessionId, Set<InetAddress> participants, boolean isForced) throws NoSuchRepairSessionException
    {
