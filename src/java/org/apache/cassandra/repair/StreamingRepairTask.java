...
public class StreamingRepairTask implements Runnable, StreamEventHandler
{
    ...
    public static final String REPAIR_STREAM_PLAN_NAME = "Repair";
    ...
    public void run()
    {
        ...
        new StreamPlan(REPAIR_STREAM_PLAN_NAME, repairedAt, 1, false, isIncremental, isConsistent ? desc.parentSessionId : null).listeners(this)
