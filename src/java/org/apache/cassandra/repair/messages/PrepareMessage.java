...
public class PrepareMessage extends RepairMessage
{
    ...
    public PrepareMessage(UUID parentRepairSession, List<UUID> cfIds, Collection<Range<Token>> ranges, boolean isIncremental, long timestamp, boolean isGlobal, PreviewKind previewKind)
    {
    ...
    public int hashCode()
    {
        return Objects.hash(messageType, parentRepairSession, isGlobal, previewKind, isIncremental, timestamp, cfIds, ranges);
    }
    ...
    public static class PrepareMessageSerializer implements MessageSerializer<PrepareMessage>
    {
        ...
        public PrepareMessage deserialize(DataInputPlus in, int version) throws IOException
        {
            ...
            return new PrepareMessage(parentRepairSession, cfIds, ranges, isIncremental, timestamp, isGlobal, previewKind);
        }
