...
public abstract class ColumnFilter
{
    ...
    {
        if (!returnStaticContentOnPartitionWithNoRows && DatabaseDescriptor.getAllRegularAndQueriedStaticColumnFilterEnabled())
        {
    ...
    public static class Serializer
    {
        ...
        public ColumnFilter deserialize(DataInputPlus in, int version, TableMetadata metadata) throws IOException
        {
            ...
            if (isFetchAll)
            {
                ...
                if (!isFetchAllStatics && version >= MessagingService.VERSION_40)
                {
