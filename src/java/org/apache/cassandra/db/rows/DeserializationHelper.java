...
public class DeserializationHelper
{
    ...
    public DeserializationHelper(CFMetaData metadata, int version, Flag flag, ColumnFilter columnsToFetch)
    {
        this.flag = flag;
    ...
    public DeserializationHelper(CFMetaData metadata, int version, Flag flag)
    {
