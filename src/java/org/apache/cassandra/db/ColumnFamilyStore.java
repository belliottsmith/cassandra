    ...
    */
                             ...
                             boolean offline)
    {
        ...
        if (DatabaseDescriptor.isDaemonInitialized())
            initialMemtable = new Memtable(CommitLog.instance.getCurrentPosition(), this);
    ...
    private final class PostFlush implements Callable<CommitLogPosition>
    {
        ...
        public CommitLogPosition call()
        {
            ...
            CommitLogPosition commitLogContiguousUpperBound = CommitLogPosition.NONE;
            ...
            if (flushFailure == null && !memtables.isEmpty())
            {
                ...
                CommitLog.instance.discardCompletedSegments(metadata.id, memtable.prevCommitLogContiguousUpperBound(), commitLogContiguousUpperBound);
            }
    ...
    private final class Flush implements Runnable
    {
        ...
        private Flush(boolean truncate)
        {
            ...
            CommitLogPosition commitLogBoundary = CommitLog.instance.getCurrentPosition();
    ...
    public void clearUnsafe()
    {
        for (final ColumnFamilyStore cfs : concatWithIndexes())
        {
            cfs.runWithCompactionsDisabled(new Callable<Void>()
            {
                public Void call()
                {
                    cfs.data.reset(new Memtable(CommitLog.instance.getCurrentPosition(), cfs));
                    return null;
                }
            }, true, false);
        }
