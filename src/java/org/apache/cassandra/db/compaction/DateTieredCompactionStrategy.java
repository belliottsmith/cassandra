...
public class DateTieredCompactionStrategy extends AbstractCompactionStrategy
{
    ...
    public synchronized AbstractCompactionTask getNextBackgroundTask(int gcBefore)
    {
        ...
        while (true)
        {
            ...
            Transaction modifier = cfs.getDataTracker().tryModify(latestBucket, OperationType.COMPACTION);
            if (modifier != null)
    ...
    {
        Transaction modifier = cfs.markAllCompacting(OperationType.COMPACTION);
        if (modifier == null)
            return null;
    ...
    public synchronized AbstractCompactionTask getUserDefinedTask(Collection<SSTableReader> sstables, int gcBefore)
    {
        ...
        Transaction modifier = cfs.getDataTracker().tryModify(sstables, OperationType.COMPACTION);
        if (modifier == null)
        {
