...
public class LeveledCompactionStrategy extends AbstractCompactionStrategy
{
    ...
    public synchronized AbstractCompactionTask getNextBackgroundTask(int gcBefore)
    {
        ...
        while (true)
        {
            ...
            Transaction txn = cfs.getDataTracker().tryModify(candidate.sstables, OperationType.COMPACTION);
            if (txn != null)
            {
    ...
    @Override
    public AbstractCompactionTask getCompactionTask(Transaction txn, int gcBefore, long maxSSTableBytes)
    {
