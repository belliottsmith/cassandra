...
public class SSTableSplitter {
    ...
    public SSTableSplitter(ColumnFamilyStore cfs, Transaction transaction, int sstableSizeInMB)
    {
    ...
    public static class SplittingCompactionTask extends CompactionTask
    {
        ...
        public SplittingCompactionTask(ColumnFamilyStore cfs, Transaction transaction, int sstableSizeInMB)
        {
