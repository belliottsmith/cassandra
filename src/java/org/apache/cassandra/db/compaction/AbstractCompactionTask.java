...
public abstract class AbstractCompactionTask extends WrappedRunnable
{
     ...
     */
    public AbstractCompactionTask(ColumnFamilyStore cfs, Transaction transaction)
    {
        this.cfs = cfs;
    ...
    public abstract CompactionAwareWriter getCompactionAwareWriter(ColumnFamilyStore cfs, Transaction txn, Set<SSTableReader> nonExpiredSSTables);
