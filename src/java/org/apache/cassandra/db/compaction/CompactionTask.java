...
public class CompactionTask extends AbstractCompactionTask
{
    ...
    public CompactionTask(ColumnFamilyStore cfs, Transaction txn, int gcBefore, boolean offline)
    {
        super(cfs, txn);
    ...
    @Override
    public CompactionAwareWriter getCompactionAwareWriter(ColumnFamilyStore cfs, Transaction transaction, Set<SSTableReader> nonExpiredSSTables)
    {
