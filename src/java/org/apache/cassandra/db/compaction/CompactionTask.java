...
public class CompactionTask extends AbstractCompactionTask
{
    ...
    protected final CompactionController getCompactionController(Set<SSTableReader> toCompact)
    {
        ...
        if (metadata.isAccordEnabled())
        {
            ...
            gcBeforeSeconds = node.commandStores().mapReduceUnsafe(selector, (ignore, commandStore) -> commandStore.unsafeGetRedundantBefore().foldl(ignore, (bs, v) -> bs.maxBound(LOCALLY_APPLIED).hlc(), Long.MAX_VALUE), Math::min, gcBeforeSeconds);
