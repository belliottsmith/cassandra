...
public class MajorLeveledCompactionWriter extends CompactionAwareWriter
{
    ...
    public MajorLeveledCompactionWriter(ColumnFamilyStore cfs, Transaction txn, Set<SSTableReader> nonExpiredSSTables, long maxSSTableSize, boolean offline, OperationType compactionType)
    {
