...
public class SSTableImporter
{
    ...
    synchronized List<String> importNewSSTables(Options options)
    {
        ...
        try (Refs<SSTableReader> refs = Refs.ref(newSSTables))
        {
            ...
            cfs.indexManager.buildAllIndexesBlocking(newSSTables);
    ...
    private File getTargetDirectory(String srcPath, Descriptor descriptor, Set<Component> components)
    {
        ...
        return cfs.getDirectories().getWriteableLocationToLoadFile(new File(descriptor.baseFilename()));
    }
     ...
     */
    private void invalidateCachesForSSTable(Descriptor desc)
    {
