...
public class Gossiper implements IFailureDetectionEventListener, GossiperMBean
{
    ...
    public static class Props
    {
        ...
        public static final String DISABLE_THREAD_CORRECTION = "cassandra.gossip.disable_thread_correction";
    }
    ...
    private static volatile boolean disableThreadCorrection = Boolean.getBoolean(Props.DISABLE_THREAD_CORRECTION);
    ...
    public void setThreadCorrectionDisabled(boolean disabled)
    {
        disableThreadCorrection = disabled;
    }

    public boolean isThreadCorrectionDisabled()
    {
    ...
    public static void runInGossipStageBlocking(Runnable runnable)
    {
        ...
        if (isInGossipStage() || disableThreadCorrection)
        {
            runnable.run();
            return;
        }
