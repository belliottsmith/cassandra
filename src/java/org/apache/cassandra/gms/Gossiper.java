...
public class Gossiper implements IFailureDetectionEventListener, GossiperMBean
{
    ...
    {
        return ((JMXEnabledSingleThreadExecutor) Stage.GOSSIP.getExecutor()).isExecutedBy(Thread.currentThread());
    }
    ...
    public static void runInGossipStageBlocking(Runnable runnable)
    {
        ...
        Stage.GOSSIP.getExecutor().execute(task);
        try
        {
            task.get();
        }
    ...
    private void doStatusCheck()
    {
        ...
        long pending = ((JMXEnabledThreadPoolExecutor) Stage.GOSSIP.getExecutor()).metrics.pendingTasks.getValue();
