...
public class ActiveRepairService implements IEndpointStateChangeSubscriber, IFailureDetectionEventListener, ActiveRepairServiceMBean
{
    ...
    public static boolean verifyNoIncRepairMigration(UUID parentRepairSession, List<ColumnFamilyStore> columnFamilyStores, boolean isIncremental, PreviewKind previewKind, Collection<Range<Token>> ranges)
    {
    ...
    public void setRepairMessageTimeoutMillis(long timeoutMillis)
    {
        ...
        DatabaseDescriptor.setRepairMessageTimeout(timeoutMillis, TimeUnit.MILLISECONDS);
    }
