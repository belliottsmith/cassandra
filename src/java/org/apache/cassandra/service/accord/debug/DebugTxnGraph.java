...
public abstract class DebugTxnGraph<T, P>
{
    ...
    public DebugTxnGraph(IAccordService service, TxnId root, @Nullable Participants<?> intersecting, TxnKindsAndDomains kinds, Timestamp min, int maxDepth, Consumer<? super TxnInfos<T>> visit)
    {
