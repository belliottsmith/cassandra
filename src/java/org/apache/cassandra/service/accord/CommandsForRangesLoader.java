...
public class CommandsForRangesLoader implements AccordStateCache.Listener<TxnId, Command>
{
    ...
    public static class Summary
    {
        ...
        {
            return new Summary(txnId, executeAt, saveStatus, ranges == null ? null : ranges.slice(slice, Routables.Slice.Minimal), findAsDep, hasAsDep);
        }
    ...
    public class Loader
    {
        ...
        private Summary from(TxnId txnId, Timestamp executeAt, SaveStatus saveStatus, StoreParticipants participants, @Nullable PartialDeps partialDeps)
        {
            ...
            ranges = ranges.slice(searchRanges, Routables.Slice.Minimal);
            if (ranges.isEmpty())
                return null;
            ...
            return new Summary(txnId, executeAt, saveStatus, ranges, null, false);
        }
    }
}
