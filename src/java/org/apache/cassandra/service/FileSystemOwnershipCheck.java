 ...
 *   derived from system properties. For version 1, this is of the form:
 *   <application name>/<cluster name>/<instance id>
 *   (see constructTokenFromProperties())
 *
 ...
 *   value returned by constructTokenFromProperties().
...
public class FileSystemOwnershipCheck implements StartupCheck
{
    ...
    // Used to construct the token for matching against property file values
    ...
    private String constructTokenFromProperties() throws StartupException
    {
