...
public class CompactionMetadata extends MetadataComponent
{
    ...
    {
        public int serializedSize(CompactionMetadata component, Descriptor.Version version) throws IOException
        {
            int size = 0;
        ...
        public void serialize(CompactionMetadata component, Descriptor.Version version, DataOutputPlus out) throws IOException
        {
