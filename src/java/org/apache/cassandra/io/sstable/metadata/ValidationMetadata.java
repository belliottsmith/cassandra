...
public class ValidationMetadata extends MetadataComponent
{
    ...
    {
        public int serializedSize(ValidationMetadata component, Descriptor.Version version) throws IOException
        {
            return TypeSizes.NATIVE.sizeof(component.partitioner) + 8;
        }

        public void serialize(ValidationMetadata component, Descriptor.Version version, DataOutputPlus out) throws IOException
        {
