...
public class StatsMetadata extends MetadataComponent
{
    ...
    {
        public int serializedSize(StatsMetadata component, Descriptor.Version version) throws IOException
        {
            int size = 0;
        ...
        public void serialize(StatsMetadata component, Descriptor.Version version, DataOutputPlus out) throws IOException
        {
