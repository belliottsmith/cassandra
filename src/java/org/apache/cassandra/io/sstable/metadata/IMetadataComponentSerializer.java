...
public interface IMetadataComponentSerializer<T extends MetadataComponent>
{
     ...
     * @throws IOException
     */
    int serializedSize(T component, Descriptor.Version version) throws IOException;
     ...
     * @throws IOException
     */
    void serialize(T component, Descriptor.Version version, DataOutputPlus out) throws IOException;
