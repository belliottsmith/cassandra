...
public class IndexSummaryRedistribution extends CompactionInfo.Holder
{
                                                     ...
                                                     double totalReadsPerSec, long memoryPoolCapacity) throws IOException
    {
        ...
        remainingBytes = memoryPoolCapacity;
        for (SSTableReader sstable : sstables)
        {
            ...
            long idealSpace = Math.round(remainingBytes * (readsPerSec / totalReadsPerSec));
            ...
            else if (effectiveIndexInterval > maxIndexInterval)
            {
                ...
                remainingBytes -= avgEntrySize * numEntriesAtNewSamplingLevel;
            }
        ...
        if (remainingBytes > 0)
        {
            Pair<List<SSTableReader>, List<ResampleEntry>> result = distributeRemainingSpace(toDownsample, remainingBytes);
    ...
    {
        return new CompactionInfo(OperationType.INDEX_SUMMARY, (remainingBytes - memoryPoolBytes), memoryPoolBytes, "bytes");
    }
