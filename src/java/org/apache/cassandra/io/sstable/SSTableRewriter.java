...
public class SSTableRewriter extends Transactional.AbstractTransactional implements Transactional
{
    ...
    private final Transaction transaction; // the readers we are rewriting (updated as they are replaced)
    ...
    public SSTableRewriter(ColumnFamilyStore cfs, Transaction transaction, long maxAge, boolean isOffline)
    {
