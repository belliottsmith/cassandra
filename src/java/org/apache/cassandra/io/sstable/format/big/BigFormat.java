...
public class BigFormat implements SSTableFormat
{
    ...
    @Override
    public RowIndexEntry.IndexSerializer getIndexSerializer(CFMetaData metadata, Descriptor descriptor, SerializationHeader header)
    {
        return new RowIndexEntry.Serializer(metadata, descriptor, header);
    }
    ...
    static class WriterFactory extends SSTableWriter.Factory
    {
        ...
        {
            return new BigTableWriter(descriptor, keyCount, repairedAt, pendingRepair, metadata, metadataCollector, header, lifecycleNewTracker);
        }
    }
    ...
    {
        public static final String current_version = "mf";
