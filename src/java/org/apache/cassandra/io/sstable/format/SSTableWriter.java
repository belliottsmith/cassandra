...
public abstract class SSTableWriter extends SSTable implements Transactional
{
                                       ...
                                       LifecycleNewTracker lifecycleNewTracker)
    {
        ...
        return writerFactory.open(descriptor, keyCount, repairedAt, pendingRepair, metadata, metadataCollector, header, lifecycleNewTracker);
    }

    public static SSTableWriter create(Descriptor descriptor, long keyCount, long repairedAt, UUID pendingRepair, int sstableLevel, SerializationHeader header, LifecycleNewTracker lifecycleNewTracker)
    {
        CFMetaData metadata = Schema.instance.getCFMetaData(descriptor);
        return create(metadata, descriptor, keyCount, repairedAt, pendingRepair, sstableLevel, header, lifecycleNewTracker);
    }
                                       ...
                                       LifecycleNewTracker lifecycleNewTracker)
    {
        ...
        return create(descriptor, keyCount, repairedAt, pendingRepair, metadata, collector, header, lifecycleNewTracker);
    }

    public static SSTableWriter create(String filename, long keyCount, long repairedAt, UUID pendingRepair, int sstableLevel, SerializationHeader header, LifecycleNewTracker lifecycleNewTracker)
    {
        return create(Descriptor.fromFilename(filename), keyCount, repairedAt, pendingRepair, sstableLevel, header, lifecycleNewTracker);
    }

    @VisibleForTesting
    public static SSTableWriter create(String filename, long keyCount, long repairedAt, UUID pendingRepair, SerializationHeader header, LifecycleNewTracker lifecycleNewTracker)
    {
        return create(Descriptor.fromFilename(filename), keyCount, repairedAt, pendingRepair, 0, header, lifecycleNewTracker);
    }
