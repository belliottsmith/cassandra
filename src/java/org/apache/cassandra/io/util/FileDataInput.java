...
public class FileDataInput extends SeekableDataInput
{
    ...
    protected FileDataInput(Builder builder)
    {
    ...
    public static class Builder
    {
        ...
        public FileDataInput buildWithChannel()
        {
            return new FileDataInputWithOwnChannel(this);
        }
    }
    ...
    public static class FileDataInputWithOwnChannel extends FileDataInput
    {
        protected FileDataInputWithOwnChannel(Builder builder)
        {
            super(builder);
        }
    ...
    public static FileDataInput open(File file)
    {
        return new Builder(new ChannelProxy(file)).buildWithChannel();
    }

    public static FileDataInput open(ChannelProxy channel)
    {
