 ...
 */
public class CappedSortedMapType<E> extends MapType<TimeUUID, E>
{
    final private static AbstractType<TimeUUID> keyType = ReversedType.getInstance(TimeUUIDType.instance);
