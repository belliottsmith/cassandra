...
|commitlog_tables |Commitlog usage by keyspace/table

|commitlog_segments |Unflushed tables for each active commitlog segment

|commitlog_segments_map |Which tables have unflushed data in each active commitlog segment
