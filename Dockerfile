# Image defined here: https://github.pie.apple.com/pie/cassandra-automation/blob/develop/dockerimages/jdkbaseimage/Dockerfile-cpbuild7-JDK11Base
FROM docker.apple.com/piedb7/applejdk-11:latest
