...
ant -f rio-build.xml -Drelease=true -Dbase.version="${VERSION}" -Dno-javadoc artifacts dtest-jar sources-jar
ant -f rio-build.xml -Drelease=true -Dbase.version="${VERSION}" javadoc-jar || true
